...
const CURRENT_LINK = "/use-cases/la-purple-line-3-stations";

const HERO_TAGS = ["Monitoring", "Purple Line 3", "Los Angeles", "USA"];

const solutionData = [
  "Centralized construction, engineering, and monitoring data from multiple sources",
  "Real-time station construction progress and underground activity",
  "Critical project milestone tracking",
  "Interactive visualization dashboards for every stakeholder",
  "Automated reporting and digital documentation workflows",
  "Asset tracking and project documentation records",
  "Project analytics and decision-support intelligence",
];

const keyTools = [
  "Centralized dashboards that turned complex project data into meaningful insights",
  "Real-time monitoring of station construction progress and project milestones",
  "Automated reporting workflows that improved data consistency and accuracy",
  "Asset intelligence and analytics across documentation and construction activities",
];
...
const impactPoints = [
  {
    ...
    rest: "into station construction progress and performance",
  },
  {
    icon: AlertTriangle,
    lead: "Faster decisions",
    rest: "by responding quickly to real-time project insights",
  },
  {
    icon: ShieldCheck,
    lead: "Enhanced collaboration",
    rest: "between contractors, engineers, consultants, and owners",
  },
  {
    icon: FileCheck,
    lead: "Greater efficiency",
    rest: "through automated, accurate reporting workflows",
  },
];
  ...
  >
    ...
    <div className="relative h-[260px] w-full self-end overflow-hidden rounded-2xl border border-white/20 shadow-2xl sm:h-[340px] md:w-[55%]">
      ...
      <div className="absolute left-5 top-16 z-20 max-w-[210px] rounded-xl border border-white/10 bg-[#1a1b20]/95 p-4 text-xs text-white shadow-xl backdrop-blur-md">
        ...
        <p className="mb-2 text-gray-400">Optical Target | Westwood/UCLA</p>
...
/*  Page                                                               */
/* ------------------------------------------------------------------ */
const PurpleLine3Stations = () => {
  const suggestions = successStories.filter((s) => s.link !== CURRENT_LINK);

  return (
<>
     <SEO
        title="LA Purple Line 3 Stations Case Study | TeraStamp"
        description="Discover how TeraStamp supported the LA Metro Purple Line 3 Stations project with Digital Twin technology, real-time infrastructure monitoring, centralized data management, automated reporting, and intelligent project analytics."
        keywords="LA Purple Line 3 Stations, Purple Line Case Study, Metro Infrastructure Monitoring, Tunnel Monitoring, Transportation Infrastructure, Digital Twin Case Study, Construction Monitoring, Infrastructure Monitoring Software, Real-Time Monitoring, GIS Monitoring, Automated Reporting, Project Analytics, TeraStamp"
      />
    <main className="bg-white">
      ...
      <section className="mx-auto max-w-5xl px-4 pt-16 sm:px-6 md:pt-20">
        ...
        >
           LA Purple Line 3{" "}
          <span className="text-[#F26418]"> Stations</span>
        </motion.h1>
        ...
        >
          TeraStamp's software team supported the final phase of the LA Metro D
          Line Extension, delivering digital monitoring, data management, and
          reporting solutions across the Westside corridor.
        </motion.p>
        ...
        >
          <img
            src="/la-purple-line-3-stations.jpg"
            alt="LA Metro Purple Line 3 underground station construction"
            className="h-full w-full object-cover"
            onError={(e) => (e.currentTarget.style.display = "none")}
          />
        </motion.div>
      ...
      <section className="mx-auto mt-14 max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            The Purple Line 3 Stations project forms the final phase of the Los
            Angeles Metro D Line (formerly Purple Line) Extension, one of the
            largest public transportation investments in Southern California. It
            includes major underground stations at Westwood/UCLA and Westwood/VA
            Hospital, expanding the metro network deeper into the Westside
            corridor.
          </motion.p>
          <motion.p {...rise(2)}>
            Designed to improve mobility, reduce traffic congestion, and provide
            sustainable transportation options, the project plays a critical role
            in connecting residents, students, healthcare professionals, and
            visitors to key destinations across the city.
          </motion.p>
          <motion.p {...rise(3)}>
            Delivered for the Los Angeles County Metropolitan Transportation
            Authority, a program of this scale demanded accurate, timely data to
            keep every team aligned from day one.
          </motion.p>
        </div>
      </section>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            Building deep underground stations required continuous monitoring and
            coordination among multiple engineering and construction teams,
            generating thousands of construction updates, engineering records,
            monitoring points, and project documents to organize efficiently.
          </motion.p>
          <motion.p {...rise(2)}>
            With contractors, engineers, consultants, and project owners all
            needing reliable, up-to-date information, traditional reporting was
            too slow to support daily operations and critical decisions.
          </motion.p>
        </div>

        <div className="mt-9">
          <PlatformFrame
            src="/purpleline3stationchalleng.jpeg"
            alt="Project map with station zones and monitoring locations"
          />
        </div>
      </section>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        >
          Our software team delivered a scalable digital infrastructure platform
          that brought project information into a single environment and improved
          monitoring, reporting, and project intelligence across the lifecycle.
        </motion.p>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        >
          Bringing every workflow into a single platform improved data
          accessibility and gave stakeholders real{" "}
          <span className="font-semibold text-[#32353A]">oversight</span> — with
          centralized information and live insights, teams stayed responsive and
          in control at every stage.
        </motion.p>

        <div className="mt-9">
          <PlatformFrame
            src="/purpleline3stationimpac.jpeg"
      ...
      {/* ===== Key insights ===== */}
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        <SectionTitle>Key insights from the Purple Line 3 Stations</SectionTitle>
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            Large-scale underground transit programs take more than strong design
            — they rely on clear, real-time data to guide them at every step. On
            the Purple Line 3 Stations, TeraStamp turned complex project data into
            actionable insights teams could trust, moving them from simply
            observing progress to actively managing it.
          </motion.p>
          <motion.p {...rise(2)}>
            In major urban transit, the real value isn't only efficient delivery
            — it's protecting the people and systems that depend on the project.
            With centralized intelligence and automated reporting, the team could
            take that responsibility seriously and stay a step ahead.
          </motion.p>
...
export default PurpleLine3Stations;