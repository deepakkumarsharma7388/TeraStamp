...
const CURRENT_LINK = "/use-cases/la-purple-line-3-tunnels";

const HERO_TAGS = ["Monitoring", "Tunnel", "Los Angeles", "USA"];

const solutionData = [
  "Centralized engineering, construction, and monitoring information",
  "Real-time tunnel construction activity and milestones",
  "Operational performance metrics across the project",
  ...
  "Infrastructure analytics and project intelligence",
];

const keyTools = [
  "Centralized dashboards that turned complex project data into actionable insights",
  "Real-time monitoring of tunnel construction activities and project milestones",
  "Automated reporting workflows that improved transparency and reduced manual effort",
  "Infrastructure analytics across construction progress and critical project metrics",
];
...
const impactPoints = [
  {
    ...
    rest: "into tunnel construction progress and performance",
  },
  {
    icon: AlertTriangle,
  ...
  },
  {
    ...
    rest: "between contractors, consultants, engineers, and teams",
  },
  {
    icon: FileCheck,
  ...
  >
    ...
    <div className="relative h-[260px] w-full self-end overflow-hidden rounded-2xl border border-white/20 shadow-2xl sm:h-[340px] md:w-[55%]">
      ...
      <div className="absolute left-5 top-16 z-20 max-w-[210px] rounded-xl border border-white/10 bg-[#1a1b20]/95 p-4 text-xs text-white shadow-xl backdrop-blur-md">
        ...
        <p className="mb-2 text-gray-400">Convergence | Westside Tunnel</p>
  ...
  return (
    ...
    <main className="bg-white">
      ...
      <section className="mx-auto max-w-5xl px-4 pt-16 sm:px-6 md:pt-20">
        ...
        >
          TeraStamp's software team supported the twin-bore tunnel construction of
          the LA Metro D Line Extension, delivering digital monitoring, data
          management, and reporting beneath one of Southern California's busiest
          urban corridors.
        </motion.p>
      ...
      <section className="mx-auto mt-14 max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            The Purple Line 3 Tunnels project forms a critical component of the
            Los Angeles Metro D Line Extension, one of the most significant
            transportation infrastructure investments in the United States. It
            involved the construction of underground twin-bore tunnels connecting
            key transit stations and extending metro service deeper into the
            Westside corridor.
          </motion.p>
          <motion.p {...rise(2)}>
            The tunnel system was designed to support faster, more reliable public
            transportation while reducing traffic congestion and improving
            regional connectivity. Built beneath one of the busiest urban
            environments in Southern California, it required advanced engineering,
            precise monitoring, and effective coordination among many
            stakeholders.
          </motion.p>
          <motion.p {...rise(3)}>
            Delivered for the Los Angeles County Metropolitan Transportation
            Authority, a project of this scale demanded accurate, timely data to
            keep every team aligned throughout construction.
          </motion.p>
        </div>
      </section>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            ...
            coordination within a dense urban environment, generating high volumes
            of engineering records, monitoring data, construction updates, and
            project documentation to manage efficiently.
          </motion.p>
          <motion.p {...rise(2)}>
            With multiple contractors, consultants, engineers, and project teams
            needing consistent, reliable information, maintaining accurate
            reporting and real-time visibility across the work was a significant
            challenge.
          </motion.p>
        </div>
        ...
        <div className="mt-9">
          <PlatformFrame
            src="/purpleline3tunnelschalleng.jpeg"
            alt="Tunnel alignment map with monitoring locations"
          />
        </div>
      </section>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        >
          ...
          teams real-time access to project information throughout the tunnel
          development.
        </motion.p>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        >
          ...
          in control at every stage of the tunnel delivery.
        </motion.p>

        <div className="mt-9">
          <PlatformFrame
            src="/purpleline3tunnelsimpac.jpeg"
            alt="Dashboard with tunnel metrics and reporting"
          />
        </div>
      </section>
      ...
      {/* ===== Key insights ===== */}
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        <SectionTitle>Key insights from the Purple Line 3 Tunnels</SectionTitle>
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            Large-scale underground tunneling takes more than careful planning —
            it relies on clear, real-time data to guide it at every step. On the
            Purple Line 3 Tunnels, TeraStamp turned complex project data into
            actionable insights teams could trust, moving them from simply
            observing progress to actively managing it.
          </motion.p>
          <motion.p {...rise(2)}>
            In major underground transit, the real value isn't only efficient
            delivery — it's protecting the people and systems that depend on the
            project. With centralized intelligence and automated reporting, the
            team could take that responsibility seriously and stay a step ahead.
          </motion.p>
...
export default PurpleLine3Tunnels;