...
const CURRENT_LINK = "/use-cases/vta-bart-phase-2-cp2-ewp-3c";

const HERO_TAGS = ["Monitoring", "BART Phase II", "San Jose", "USA"];

const solutionData = [
  "Centralized engineering, construction, and project information from multiple sources",
  "Real-time construction activity and infrastructure preparation progress",
  "Project milestone and performance tracking",
  ...
  "Infrastructure analytics and decision-support intelligence",
];

const keyTools = [
  "Centralized dashboards that turned engineering and construction data into actionable insights",
  "Real-time monitoring of construction activities and infrastructure preparation",
  "Automated reporting workflows that improved transparency and reduced manual effort",
  "Infrastructure analytics to track milestones and identify potential risks early",
];
...
const impactPoints = [
  ...
  },
  {
    ...
    rest: "supporting proactive issue resolution and operational planning",
  },
  {
    icon: ShieldCheck,
    lead: "Enhanced collaboration",
    rest: "across project teams, contractors, and agencies",
  },
  {
    icon: FileCheck,
  ...
  >
    ...
    <div className="relative h-[260px] w-full self-end overflow-hidden rounded-2xl border border-white/20 shadow-2xl sm:h-[340px] md:w-[55%]">
      ...
      <div className="absolute left-5 top-16 z-20 max-w-[210px] rounded-xl border border-white/10 bg-[#1a1b20]/95 p-4 text-xs text-white shadow-xl backdrop-blur-md">
        ...
        <p className="mb-2 text-gray-400">Optical Target | San Jose</p>
  ...
  return (
    <main className="bg-white">
      ...
      <section className="mx-auto max-w-5xl px-4 pt-16 sm:px-6 md:pt-20">
        ...
        >
          Digital intelligence for VTA's{" "}
          <span className="text-[#F26418]">BART Phase II</span> — CP2 EWP 3C
        </motion.h1>
        ...
        >
          TeraStamp's software team supported critical enabling works for the BART
          Silicon Valley Phase II Program, delivering digital monitoring, project
          analytics, and reporting solutions across San Jose.
        </motion.p>
        ...
        >
          <img
            src="/VT.jpeg"
            alt="VTA BART Phase II infrastructure works in San Jose"
            className="h-full w-full object-cover"
            onError={(e) => (e.currentTarget.style.display = "none")}
          />
        </motion.div>
      ...
      <section className="mx-auto mt-14 max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            The VTA BART Silicon Valley Phase II Program is one of the largest
            transit infrastructure projects in Northern California, extending Bay
            Area Rapid Transit service into downtown San Jose and Santa Clara. The
            CP2 Early Works Package (EWP) 3C project supports critical enabling
            works required for the successful delivery of the broader transit
            expansion program.
          </motion.p>
          <motion.p {...rise(2)}>
            The project involves utility relocations, infrastructure preparation,
            site development, and construction support activities that pave the
            way for future underground stations, tunnels, and transit facilities —
            improving regional connectivity, easing congestion, and enabling
            sustainable transportation across Silicon Valley.
          </motion.p>
          <motion.p {...rise(3)}>
            Delivered for the Santa Clara Valley Transportation Authority, a
            program of this scale demanded accurate, timely data to keep every
            team aligned throughout the enabling works.
          </motion.p>
        </div>
      </section>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            Extensive enabling works required careful planning, tracking, and
            coordination across multiple contractors and agencies, while large
            volumes of engineering, construction, and project documentation needed
            to be organized and managed efficiently.
          </motion.p>
          <motion.p {...rise(2)}>
            With many project teams needing consistent, accurate information,
            maintaining real-time visibility and up-to-date reporting throughout
            the project lifecycle was essential for oversight and decision-making.
          </motion.p>
        </div>

        <div className="mt-9">
          <PlatformFrame
            src="/VTAchalleng.jpeg"
            alt="Project site map with enabling works and monitoring locations"
          />
        </div>
      </section>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        >
          Our software team delivered a scalable digital platform that supported
          infrastructure monitoring, reporting, and project intelligence, giving
          teams real-time access to project information across construction
          activities.
        </motion.p>
      ...
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        ...
        >
          ...
          in control of the enabling works at every stage.
        </motion.p>
      ...
      {/* ===== Key insights ===== */}
      <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
        <SectionTitle>Key insights from the BART Phase II works</SectionTitle>
        <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5C636E] md:text-lg">
          <motion.p {...rise(1)}>
            Large-scale transit infrastructure takes more than coordination across
            many contractors and agencies — it relies on clear, real-time data to
            guide it at every step. On the BART Phase II CP2 EWP 3C works,
            TeraStamp turned complex project data into actionable insights teams
            could trust, moving them from simply observing progress to actively
            managing it.
          </motion.p>
          <motion.p {...rise(2)}>
            In major regional transit expansion, the real value isn't only
            efficient delivery — it's enabling the future network that communities
            will depend on. With centralized intelligence and automated reporting,
            the team could take that responsibility seriously and stay a step
            ahead.
          </motion.p>
