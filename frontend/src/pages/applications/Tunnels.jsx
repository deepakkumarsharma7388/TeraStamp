...
const Tunnels = () => {
  return (
    <>
      <SEO
        title="Tunnel Monitoring Software | TBM & Conventional Tunnel Monitoring | TeraStamp"
        description="Monitor TBM and conventional tunnel projects with TeraStamp's AI-powered Tunnel Monitoring Software. Integrate Digital Twins, BIM, GIS, TBM performance, geotechnical sensors, LiDAR, UAV surveys, IoT instrumentation, predictive analytics, and real-time tunnel monitoring for safer and more efficient infrastructure projects."
        keywords="Tunnel Monitoring Software, TBM Monitoring Software, Tunnel Boring Machine Monitoring, Conventional Tunnel Monitoring, Tunnel Infrastructure Monitoring, Geotechnical Monitoring, Tunnel Digital Twin, BIM Tunnel Monitoring, GIS Tunnel Monitoring, Tunnel Settlement Monitoring, Tunnel Convergence Monitoring, Tunnel Instrumentation, LiDAR Tunnel Survey, UAV Tunnel Inspection, Tunnel Safety Monitoring, Tunnel Asset Management, Predictive Tunnel Analytics, Infrastructure Monitoring Software, TeraStamp"
      />
      <main className="bg-white py-16 md:py-20">
        ...
        <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
          <motion.h2
            {...rise(0)}
            className="mb-7 text-3xl font-bold tracking-tight text-black md:text-5xl"
          >
        ...
        <section className="mx-auto mt-16 max-w-5xl px-4 sm:px-6">
          <motion.h3
            {...rise(0)}
            className="mb-7 text-2xl font-bold tracking-tight text-black md:text-5xl"
          >
